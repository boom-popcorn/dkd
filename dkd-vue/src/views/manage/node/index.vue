<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="nodeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="点位名称" align="left" prop="nodeName" show-overflow-tooltip/>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="nodeRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="所属商圈" prop="businessType">
          <el-select v-model="form.businessType" placeholder="请选择商圈">
            <el-option
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button @click="cancel">取 消</el-button>1
        </div>
      </template>
    </el-dialog>
    <!-- 查看详情管理对话框 -->
